    ...
    <script>
        ...
        new Chart(statusCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [
                        <?php echo $summary['pending'] ?: 0; ?>, 
                        <?php echo $summary['processing'] ?: 0; ?>, 
                        <?php echo $summary['ready'] ?: 0; ?>, 
                        <?php echo $summary['released'] ?: 0; ?>
                    ],
            ...
            data: {
                ...
                datasets: [{
                    data: [
                        ...
                        <?php echo ($summary['total_amount'] - $summary['paid_amount']) ?: 0; ?>
                    ],
