...
<head>
    ...
    <style>
        ...
        .stat-card::after { content:''; position:absolute; top:0; right:0; width:80px; height:80px;
                            background:linear-gradient(135deg,rgba(128,0,0,.1),rgba(102,0,0,.1));
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="view_request.php?id=<?= (int)$r['id'] ?>"
                                   class="btn btn-sm btn-primary" style="background:maroon;border:none;">
