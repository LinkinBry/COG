...
// Get recent requests with user details
$requests_query = "SELECT r.*, u.full_name, u.student_id, u.email 
                   FROM cog_requests r 
...
<head>
    ...
    <style>
        ...
        .stat-card::after {
            ...
            width: 80px;
            height: 80px;
            background: linear-gradient(135deg, rgba(128,0,0,0.1) 0%, rgba(102,0,0,0.1) 100%);
            border-radius: 50%;
        ...
        <div class="row mb-4 g-4">
            ...
            <div class="col-md-3">
                <div class="stat-card">
                    ...
                    <h3 class="fw-bold mb-0 text-warning"><?php echo $pending_requests; ?></h3>
            ...
            <div class="col-md-3">
                <div class="stat-card">
                    ...
                    <h3 class="fw-bold mb-0 text-info"><?php echo $processing_requests; ?></h3>
            ...
            <div class="col-md-3">
                <div class="stat-card">
                    ...
                    <h3 class="fw-bold mb-0 text-success"><?php echo $ready_requests; ?></h3>
            ...
            <div class="col-md-3">
                <div class="stat-card">
                    ...
                    <h3 class="fw-bold mb-0 text-secondary"><?php echo $released_requests; ?></h3>
            ...
            <div class="col-md-3">
                <div class="stat-card">
                    <h6 class="text-muted mb-2">Today's Requests</h6>
                    <h3 class="fw-bold mb-0"><?php echo $today_requests; ?></h3>
            ...
            <div class="col-md-3">
                <div class="stat-card">
                    ...
                    <h3 class="fw-bold mb-0 text-warning"><?php echo $pending_payments; ?></h3>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <span class="fw-bold text-warning">
                                ...
                                echo number_format($pending_revenue, 2);
                                ?>
                            </span>
                        </div>
                    </div>
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <span class="fw-bold">2.5 days</span>
                        </div>
                        <div class="d-flex justify-content-between">
