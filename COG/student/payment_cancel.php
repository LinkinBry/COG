...
<head>
    ...
    <style>
        ...
        .card { border-radius:20px; box-shadow:0 10px 40px rgba(0,0,0,.12); max-width:440px; width:100%; }
        .icon-circle { width:90px; height:90px; background:#f8d7da; border-radius:50%;
...
<div class="card p-5 text-center">
    ...
    <p class="text-muted">
        You cancelled the payment process. Your COG request is still pending.<br>
        You can retry payment at any time from <strong>My Requests</strong>.
    </p>
